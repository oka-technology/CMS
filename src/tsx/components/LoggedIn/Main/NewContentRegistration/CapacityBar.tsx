...
const colorBP = { r: [0, 50, 255, 255], g: [200, 220, 220, 0], b: [255, 205, 0, 0] };
...
const color = (bytes: number) => {
  ...
  if (percent < 80) {
    ...
    return `rgb(${colorNum(colorBP.r, 1, percentInScope)}, ${colorNum(colorBP.g, 1, percentInScope)}, ${colorNum(
      colorBP.b,
      1,
      percentInScope,
    )})`;
    ...
    return `rgb(${colorNum(colorBP.r, 2, percentInScope)}, ${colorNum(colorBP.g, 2, percentInScope)}, ${colorNum(
      colorBP.b,
      2,
      percentInScope,
    )})`;
    ...
    return `rgb(${colorNum(colorBP.r, 3, percentInScope)}, ${colorNum(colorBP.g, 3, percentInScope)}, ${colorNum(
      colorBP.b,
      3,
      percentInScope,
    )})`;
  } else {
    return `rgb(${colorNum(colorBP.r, 3, 1)}, ${colorNum(colorBP.g, 3, 1)}, ${colorNum(colorBP.b, 3, 1)})`;
  }
};
