...
export const usersPage: PageData = createPageData('Users', `${TOP_PAGE_PATH}/`, false, {
  admin: true,
  editor: false,
  viewer: false,
});
export const newUserRegistrationPage: PageData = createPageData('New User Registration', `${TOP_PAGE_PATH}/`, false, {
  admin: true,
  editor: false,
  viewer: false,
});
export const contentListPage: PageData = createPageData('Content List', `${TOP_PAGE_PATH}/`, false, {
  admin: false,
  editor: true,
  viewer: true,
});
...
export const categoriesPage: PageData = createPageData('Categories', `${TOP_PAGE_PATH}/`, false, {
  admin: false,
  editor: true,
  viewer: false,
});
